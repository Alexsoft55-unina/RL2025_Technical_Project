...
def generate_launch_description():
    ...
    trajectory_execution = {
        ...
        "trajectory_execution.allowed_start_tolerance": 3.14,
        # AGGIUNGI QUESTA: Disabilita il watchdog temporale
...
# 1. Define the COMPLETE list of capabilities
    # This includes the standard defaults + the MTC capability
    move_group_capabilities = (
        ...
        "move_group/ExecuteTaskSolutionCapability" # <--- The MTC Plugin
    )
    ...
    nodes = [
        ...
        Node(
            ...
            parameters=[
                ...
                {
                    "use_sim_time": use_sim_time,
                    "capabilities": move_group_capabilities,  # <--- AGGIUNTA FONDAMENTALE
                },
            ],
        ),
        # move_servo
...
def generate_declared_arguments() -> List[DeclareLaunchArgument]:
    ...
    return [
        ...
        DeclareLaunchArgument(
            "capabilities",
            default_value="",
            description="Non-default capabilities to load",
        ),
    ]
